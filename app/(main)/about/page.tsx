...
const newspaperLinkList = [
  ...
  {
    title:
      "Công ty CP Công nghệ VNFITE Việt Nam tặng quà trung thu cho bệnh nhi tại Bệnh viện Đa khoa tỉnh Phú Thọ",
  ...
  {
    title:
      "Công ty Cổ phần Công nghệ Tài chính VNFITE Khai trương văn phòng trụ sở mới",
          ...
          <div className="flex justify-center items-center flex-col space-y-14 lg:space-y-28">
            ...
            <div>
              ...
              <p className="sm:p-4 font-normal text-base mt-0 lg:mt-14 flex flex-col space-y-7 max-w-screen-xl w-[90%] mx-auto">
                <span>
                  VNFITE là nền tảng công nghệ kết nối nhu cầu vay và nhu cầu
                  cho vay, hướng tới minh bạch và quản trị rủi ro đóng vai trò
                  kết nối giữa nhà đầu tư và người vay. Được thành lập từ năm
                  2020, VNFITE đã trở thành một đơn vị tiên phong trong lĩnh vực
                  công nghệ tài chính tại Việt Nam, giúp đơn giản hóa quy trình
                  vay vốn và đầu tư với công nghệ hiện đại. <br />
                </span>
                ...
                {isShowIntro && (
                  <>
                    <span>
                      VNFITE đang nghiên cứu/chuẩn bị hồ sơ tham gia Cơ chế thử
                      nghiệm (sandbox) theo NĐ 94/2025. Thông tin tổ chức được
                      cấp giấy chứng nhận sẽ tham gia sẽ theo công bố của NHNN
                    </span>
                    <span>
                    ...
                    <span>
                      ...
                      trường Fintech nói riêng và thị trường tài chính nói
            ...
            <div>
              ...
              <p className="p-4 font-normal text-base mt-0 lg:mt-14 flex flex-col space-y-7 max-w-screen-xl w-[90%] mx-auto">
                ...
                <span className="text-center">
                  ...
                  Fintech nói riêng và thị trường tài chính nói chung. Với mục
