	...
	return (
		<div>
			<div className="flex justify-center items-center flex-col ">
				<div className="w-full bg-grad py-10 flex justify-around items-center gap-32">
					<div className="">
						<Image
				...
				<div className="mt-28">
					...
					<div className="flex flex-col lg:flex-row mt-28 max-w-[1280px] space-y-28 space-x-0 lg:space-y-0 lg:space-x-7 mx-auto">
						<div className="bg-[#FFF8F8] max-w-[405px] w-full h-[433px] rounded-3xl border border-[#F84F4F] relative group">
							...
							<div className="absolute left-1/2 bottom-10 -translate-x-1/2 font-semibold text-gradient text-center underline z-10 cursor-pointer">
								Xem chi tiết
							</div>
					...
					<div className="flex flex-col md:flex-row md:space-x-14 items-center md:items-start">
						...
						<div className="w-full md:w-3/5 mt-4 md:mt-0 md:px-0 space-y-9">
							<div className="flex items-center space-x-4">
								<div className="rounded-full bg-grad w-6 h-6 text-white font-light">&#10004;</div>
				...
				<div className="w-full px-[16.7%] mt-16">
