export const detailNews = [
  {
    id: '1',
    mainTitle: "Mở thêm cửa tiếp cận tín dụng cho người yếu thế",
    content:
  ...
  {
    id: '2',
    mainTitle: "Các tỷ phú sẽ rót tiền vào đâu trong năm mới?",
    content: `Khảo sát của UBS với 2.682 tỷ phú toàn cầu cho thấy trong giai đoạn 2015-2024, tổng tài sản của nhóm này đã tăng 121%, đạt mức 14.000 tỷ USD.
            ...
            Do đó, theo bà Jennifer Gabrielli, Giám đốc bộ phận giải pháp tài sản siêu cao cấp tại UBS, những quyết định đầu tư của giới siêu giàu sẽ là yếu tố mà các nhà đầu tư cần theo dõi sát sao.

            "Những tỷ phú này điều hành các doanh nghiệp và ngành công nghiệp mà họ đã gắn bó trong hàng thập kỷ, thậm chí qua nhiều thế hệ. Họ hiểu rõ và cảm thấy mình có lợi thế đặc biệt trong những lĩnh vực đó", bà Gabrielli cho biết.

            Bà còn nhấn mạnh rằng ngay cả khi thoái vốn, các tỷ phú vẫn tiếp tục đầu tư vào những ngành mà họ am hiểu sâu sắc nhất.

            Theo thống kê của UBS, 3 lĩnh vực chính mà giới siêu giàu sẽ tiếp tục đầu tư mạnh trong năm 2025 là bất động sản, chứng khoán và vàng.

            Cụ thể, bất động sản tiếp tục là lĩnh vực được giới tỷ phú ưu ái nhất. Dù thị trường bất động sản thương mại và các quỹ đầu tư niêm yết đang chịu nhiều áp lực, 19% số người được hỏi vẫn có kế hoạch tăng mạnh đầu tư vào lĩnh vực này.

            Trong đó, 33% tỷ phú lựa chọn đầu tư bất động sản tại châu Mỹ, 27% tại châu Á - Thái Bình Dương và 10% tại khu vực châu Âu, Trung Đông và châu Phi.

            Xếp thứ hai trong danh mục đầu tư năm 2025 là thị trường chứng khoán với 9% tỷ phú dự định tăng mạnh đầu tư vào trái phiếu tại các thị trường phát triển, trong khi 26% có kế hoạch tăng nhẹ. Bên cạnh đó, 42% dự kiến đầu tư vào cổ phiếu ở các thị trường phát triển.

            Tiếp theo là vàng và các kim loại quý. 7% tỷ phú cho biết sẽ tăng mạnh khoản đầu tư vào nhóm tài sản này, 33% dự kiến tăng nhẹ. Đây được coi là "nơi trú ẩn an toàn" trước bất ổn kinh tế và chính trị toàn cầu.

            Theo báo cáo, mối quan tâm đến vàng và kim loại quý phần lớn xuất phát từ lo ngại về rủi ro địa chính trị gia tăng, cùng với định giá cao trên thị trường cổ phiếu.
  ...
  {
    id: '3',
    mainTitle: "Chọn kênh đầu tư năm 2025: Gửi ngân hàng, chứng khoán hay đổ vào vàng, đất?",
    content: `Vàng có thể bước vào giai đoạn "ngủ đông"
  ...
  },
  {
    ...
    mainTitle: "CHÚC MỪNG NĂM MỚI 2025",
    content: `Năm 2024 khép lại với nhiều dấu ấn đáng nhớ, và VNFITE xin gửi lời cảm ơn chân thành đến tất cả quý khách hàng, đối tác và đội ngũ nhân viên đã đồng hành, tin tưởng và cống hiến trong suốt chặng đường vừa qua.
            ...
            🌟 Chúc bạn và gia đình một năm mới tràn đầy sức khỏe, hạnh phúc và thành công rực rỡ!

            Cùng nhau, chúng ta sẽ tạo nên những cột mốc đáng tự hào trong năm 2025. 🚀💼

            #VNFITE #ChaoNamMoi2025 #NewYear2025 #VungBuocTuongLai #KhoiNguonThanhCong
            ====================================
            VNFITE – KẾT NỐI NGUỒN VỐN SIÊU TỐC
            ---------------------------------------------
            TẢI APP VNFITE NGAY, lợi ích liền tay: http://vnfite.com.vn/tai-ung-dung
  ...
  },
  {
    id: '6',
    banner: `bg-[url("/images/news/vnfiteNewYear.png")]`,
    mainTitle: "🎄 Chúc Mừng Giáng Sinh Từ VNFITE ",
    content: `Nhân dịp mùa Giáng sinh, VNFITE xin gửi lời chúc ấm áp và tốt đẹp nhất đến tất cả Quý khách hàng, đối tác, và toàn thể cán bộ nhân viên.
            ...
            Chúc mọi người một mùa Giáng sinh an lành, hạnh phúc và một Năm mới 2025 tràn đầy sức khỏe, thành công!
            Trân trọng,
            VNFITE
  ...
  },
  {
    ...
    mainTitle: "Áp lực giảm giá vẫn “rình rập” vàng trong những ngày cuối năm 2024",
    content: `Giá vàng thế giới khởi động tuần giao dịch mới vào sáng nay (23/12) tại thị trường châu Á trong trạng thái giảm nhẹ do sức ép từ đồng USD tăng giá. Dù đã hồi mạnh trong phiên ngày thứ Sáu vừa rồi, giá vàng được giới chuyên gia dự báo sẽ tiếp tục đương đầu áp lực giảm trong tuần này.
            ...
            Tuần vừa rồi, giá vàng có lúc rớt xuống mức thấp nhất 1 tháng do Cục Dự trữ Liên bang Mỹ (Fed) phát tín hiệu giảm lãi suất ít hơn trong năm 2025. Tỷ giá đồng USD và lợi suất trái phiếu kho bạc Mỹ tăng mạnh do sự dịch chuyển lập trường của Fed cũng gây áp lực mất giá lên vàng.

            Sau đó, giá vàng đã bật tăng mạnh mẽ trở lại trong phiên ngày thứ Sáu, sau khi số liệu thống kê cho thấy chỉ số giá tiêu dùng cá nhân (PCE) tháng 11 của Mỹ tăng yếu hơn so với dự báo. Nhà đầu tư bắt đầu khấp khởi hy vọng Fed có thể giảm lãi suất 3 lần trong năm tới, thay vì chỉ giảm 2 lần như dự báo mới nhất của ngân hàng trung ương này.

            Tuy nhiên, giới phân tích cho rằng đa số các dữ liệu kinh tế Mỹ gần đây đều cho thấy nền kinh tế còn vững và lạm phát có dấu hiệu chững lại trên mức mục tiêu. Thực tế này sẽ tiếp tục khiến Fed đưa ra quan điểm ít mềm mỏng hơn, và do đó đồng USD sẽ còn tăng giá, dẫn tới áp lực mất giá đè nặng lên vàng khó được giải tỏa trong ngắn hạn.

            Đồng USD bước sang tuần mới trong xu thế tăng nhẹ. Chỉ số Dollar Index đo sức mạnh của USD so với một rổ gồm 6 đồng tiền chủ chốt khác tăng gần 0,2% so với đóng cửa tuần trước, đạt gần 107,8 điểm - theo dữ liệu từ trang MarketWatch.

            Trong một báo cáo cách đây ít ngày, các nhà phân tích thị trường hàng hóa tại  công ty TD Securities nhận định triển vọng của giá vàng trong ngắn hạn vẫn nghiêng về giảm.

            “Chúng tôi không cho là sắp có một đợt bán tháo vàng - vì giả sử nền kinh tế giảm tốc, những rủi ro địa chính trị mới xuất hiện và các ngân hàng trung ương có một đợt mua vàng mới, giá vàng rất có thể sẽ tăng. Nhưng do những bất định xung quanh chính sách của Fed nếu lạm phát tiếp tục cao hơn dự kiến, chẳng hạn lạm phát bị đẩy do thuế quan của Mỹ, rất có khả năng giá vàng giảm xuống mức thấp nhất trong tháng 11 là 2.537 USD/oz”, báo cáo viết.

            Dù vậy, nhiều chuyên gia vẫn có cái nhìn lạc quan về triển vọng giá vàng trong dài hạn.

            Nhà quản lý quỹ Ryan McIntyre của công ty Sprott Inc. cho biết ông không quan trọng hóa những biến động trong ngắn hạn của giá vàng, cho rằng những bất định trên thị trường tài chính và địa chính trị sẽ tiếp tục hỗ trợ nhu cầu nắm giữ vàng để phòng ngừa rủi ro. “Nhiệm kỳ của Tổng thống đắc cử Donald Trump thậm chí còn chưa bắt đầu mà nhiều bất ổn đã xuất hiện rồi”, ông nói.

            Diễn biến gi&aacute; v&agrave;ng thế giới 10 năm qua. Đơn vị: USD/oz - Nguồn: Trading Economics.

            Diễn biến giá vàng thế giới 10 năm qua. Đơn vị: USD/oz - Nguồn: Trading Economics.
            Không ít tổ chức dự báo vẫn giữ kỳ vọng giá vàng tiếp tục tăng trong năm 2025, trong đó có những dự báo cho rằng giá vàng sẽ đạt mốc 3.000 USD/oz trong năm tới.

            Trong một báo cáo trong tháng 12 này, ngân hàng Goldman Sachs kỳ vọng giá vàng có khả năng đạt 3.000 USD/oz trước khi kết thúc năm 2025, bất chấp đồng USD tăng giá. Báo cáo nhận định lãi suất giảm và bất định địa chính trị gia tăng trên toàn cầu sẽ tiếp tục là những yếu tố thúc đẩy giá vàng.
