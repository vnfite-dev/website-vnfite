...
const Topbar = () => {
	return (
		<div className="hidden mb:flex text-[12px] text-white w-full  justify-center lg:justify-between items-center font-inter bg-gradient-to-r from-[#E82F2F] to-[#E0694F] rounded-b-2xl h-12 md:px-[120px] py-4">
