...
>(({ className, children }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex size-16 items-center justify-center rounded-fullp-3",
                className
            )}
        >
            {children}
...
>(({ className, children }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex size-52 items-center justify-center rounded-full p-3",
                className
            )}
        >
            {children}
                    ...
                    <Circle ref={div1Ref} className="size-16 relative">
                        ...
                        <div className="absolute top-3 xl:-top-2 right-20 w-28 md:w-32 lg:w-36 xl:w-72 2xl:w-80 p-1">
                            ...
                            <p className="hidden xl:block font-normal text-base text-[#666666] text-end">
                                Mọi giao dịch đều được bảo vệ bởi các tiêu chuẩn bảo mật cao
                                nhất, đảm bảo an toàn thông tin.
                            </p>
                        </div>
                    </Circle>
                    <Circle ref={div5Ref} className="size-16 relative">
                        ...
                        <div className="absolute top-3 xl:-top-2 left-20 w-28 md:w-32 lg:w-36 xl:w-72 2xl:w-80 p-1">
                            ...
                            <p className="hidden xl:block font-normal text-base text-[#666666] text-start">
                                Với hàng ngàn khách hàng đang sử dụng dịch vụ chúng tôi sẵn sàng
                                đâu tư cho bạn bất cú khi nào bạn cần.
                            </p>
                        </div>
                    </Circle>
                </div>
                <div className="flex flex-row items-center justify-between">
                    ...
                    <Circle ref={div6Ref} className="size-16 relative">
                        ...
                        <div className="absolute top-3 xl:-top-2 left-20 w-28 md:w-32 lg:w-36 xl:w-72 2xl:w-80 p-1">
                            ...
                            <p className="hidden xl:block font-normal text-base text-[#666666] text-start">
                                Các giải pháp tài chính tại VNFITE được thiết kế để hỗ trợ cả
                                nhà đầu tư và doanh nghiệp phát triển lâu dài.
                            </p>
                        </div>
                    </Circle>
                </div>
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div3Ref} className="size-16 relative">
                        ...
                        <div className="absolute top-3 xl:-top-2 right-20 w-28 md:w-32 lg:w-36 xl:w-72 2xl:w-80 p-1">
                            ...
                            <p className="hidden xl:block font-normal text-base text-[#666666] text-end">
                                Am hiểu về tài chính và công nghệ, sẵn sàng hỗ trợ từng bước
                    ...
                    <Circle ref={div7Ref} className="size-16 relative">
                        ...
                        <div className="absolute top-3 xl:-top-2 left-20 w-28 md:w-32 lg:w-36 xl:w-72 2xl:w-80 p-1">
                            ...
                            <p className="hidden xl:block font-normal text-base text-[#666666] text-start">
                                Quy trình đơn giản, trực tuyến hóa toàn bộ trải nghiệm từ đăng
                                ký đến quản lý tài chính.
                            </p>
                        </div>
                    </Circle>
                </div>
