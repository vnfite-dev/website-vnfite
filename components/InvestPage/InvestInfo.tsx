    ...
    <div className="flex justify-center">
      <div className="bg-grad rounded-3xl w-full  p-[1px] h-[252px] max-w-[292px] ">
        <div className="w-full flex flex-col justify-center items-center gap-6 bg-customPink rounded-3xl p-6 h-[250px]">
          ...
          <div className="text-center text-gradient text-lg font-semibold">
            {content}
          </div>
        </div>
      </div>
        ...
        <div className="text-white z-30">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <div className="inline-flex gap-2">
              <Image
                src="/icons/invest/whiteCheck.svg"
                alt="image"
                width={24}
                height={24}
              />
...
const InvestInfo = () => {
  const faq = [
    ...
    {
      question:
        "Tôi có thể liên hệ hỗ trợ khách hàng của VNFITE bằng cách nào?",
      answer:
    ...
    <div>
      <div className="bg-investMidBanner w-full h-fit bg-cover pb-12">
        ...
        <div className="mt-8 md:mt-24 px-[10%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-center items-center gap-8">
          <InfoBlock
            image="/icons/invest/infoblock1.svg"
            content="Lãi suất cao, đầu tư nhanh chóng"
          />
          <InfoBlock
          ...
          />
          <InfoBlock
            image="/icons/invest/infoblock3.svg"
            content="An toàn, bảo mật cao"
          />
          <InfoBlock
            image="/icons/invest/infoblock4.svg"
            content="Đa dạng sản phẩm đầu tư"
          />
        </div>
      </div>
        ...
        <div className="flex flex-col lg:gap-44 md:px-10">
          ...
          <AnimateBlock
            ...
            content={[
              ...
              "Lợi suất kỳ vọng: Lên đến ...%/năm (phụ thuộc kỳ hạn, hồ sơ, tình trạng thanh toán) Không đảm bảo",
