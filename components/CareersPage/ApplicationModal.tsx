...
const jobDetail = {
  ...
  detailLocation: [
    "Hà Nội: Tầng 6 Tai Tam building, 39A Ngô Quyền, Hàng Bài, Phan Chu Chinh, Hoàn Kiếm",
  ],
};
            ...
            {currentStep === 2 && (
              <div className="space-y-4">
                ...
                <p className="text-center px-10">
                  Cảm ơn bạn đã quan tâm và gửi thông tin ứng tuyển đến VNFITE!
                  Chúng tôi đã nhận được hồ sơ của bạn và sẽ xem xét một cách
                  cẩn thận.
                </p>
